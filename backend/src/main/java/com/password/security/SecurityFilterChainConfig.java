    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.PUT,"/api/v1/passwords/**").authenticated()
                        .requestMatchers(HttpMethod.POST,"/api/v1/passwords/**").authenticated()
                        .requestMatchers(HttpMethod.DELETE,"/api/v1/passwords/**").authenticated()
